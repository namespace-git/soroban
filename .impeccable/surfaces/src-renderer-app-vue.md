...
- 在庫の統計は当初「今月の販売用」と別カードにしていたが、finish review の指摘で契約どおり同じ白面の続き（1px 罫で区切る）に戻した。
